...
<form action="<?php echo e(BASE_URL . '/products-update'); ?>" method="POST" class="mb-3" enctype="multipart/form-data">
    ...
    <div class="mb-3">
        ...
        <input type="file" accept="image/*" class="form-control" id="exampleInputtext3" name="image" onchange="preview($('#imgTmp'))">
...
<?php echo $__env->make('admin.layouts.admin-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\da1\app\views/admin/product/edit.blade.php ENDPATH**/ ?>